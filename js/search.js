...
async function loadLink(query) {
    ...
    xhr.setRequestHeader("x-rapidapi-key", "dba0f30367msh4d70a295f4e1e52p179d63jsn6c0b1aa26c7f");
    xhr.send();
    var loaded = 0
    xhr.addEventListener("readystatechange", function () {
        if (this.readyState === this.DONE) {
            ...
            xhr2.setRequestHeader("x-rapidapi-key", "dba0f30367msh4d70a295f4e1e52p179d63jsn6c0b1aa26c7f");
            xhr2.send();
        }
    });
}